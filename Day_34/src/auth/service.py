...
SECRET_KEY = os.getenv("DAY_34_SECURITY_KEY", "your-default-secret-key")
ALGORITHM = os.getenv("DAY_34_ALGORITHM", "HS256")
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("DAY_34_ACCESS_TOKEN_EXPIRE_MINUTES", "30"))
